...
func (ac *ArticleCreate) SetOgpImage(o *OGPImage) *ArticleCreate {
	return ac.SetOgpImageID(o.ID)
}
...
func (ac *ArticleCreate) SetSite(s *Site) *ArticleCreate {
