...
func (au *ArticleUpdate) SetSite(s *Site) *ArticleUpdate {
...
func (au *ArticleUpdate) ClearSite() *ArticleUpdate {
...
func (au *ArticleUpdate) check() error {
	...
	if _, ok := au.mutation.SiteID(); au.mutation.SiteCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Article.site"`)
	}
	return nil
}
...
func (au *ArticleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.SiteCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   article.SiteTable,
			Columns: []string{article.SiteColumn},
			Bidi:    false,
...
// SetSite sets the "site" edge to the Site entity.
func (auo *ArticleUpdateOne) SetSite(s *Site) *ArticleUpdateOne {
...
// ClearSite clears the "site" edge to the Site entity.
func (auo *ArticleUpdateOne) ClearSite() *ArticleUpdateOne {
...
func (auo *ArticleUpdateOne) check() error {
	...
	if _, ok := auo.mutation.SiteID(); auo.mutation.SiteCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Article.site"`)
	}
	return nil
}
